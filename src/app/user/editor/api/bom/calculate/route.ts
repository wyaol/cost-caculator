...
function mockBomEstimator(input: StyleInput): MockEstimates {
    ...
    const consuBase = isTshirt ? 1.2 : 1.8; // T恤 1.2m, 牛仔裤 1.8m
    const laborBase = isTshirt ? 3.50 : 8.00; // T恤 $3.5, 牛仔裤 $8.0
    const trimBase = isTshirt ? 0.50 : 2.50; // T恤 $0.5, 牛仔裤 $2.5
    ...
    const widthFactor = standardWidth / input.fabricWidthCm;
